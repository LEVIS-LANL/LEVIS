print("===============================================")
print("DC-OPF LEVIS Beta Experiment") 
print("===============================================")
import sys
...
norm_type = 'infinity'
NN_verifier_instance = NN_verifier(onnx_file = file_path, problem_class=dc_opf, nn_model=model, norm_type = norm_type, epsilon_infinity=1000, margin=1e-6, center = center)

# Apply LEVIS-Beta
print("LEVIS-Beta")
regions = NN_verifier_instance.LEVIS_beta(epsilon=5, maximum_ball=True)
print(regions)