...
# ========== Step 1: Create Problem Instance (no PCA yet) ==========
problem_instance = ImageClassificationProblem(true_label_index=true_label_index)
...
model_file = f'nn_models/model_{"pca" if use_pca else "nopca"}_{n_components}.pth'
pca_file = f'pca_models/pca_{n_components}.pkl'
